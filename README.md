...
This is a fork of [rui314/chibicc](https://github.com/rui314/chibicc) ported to RISC-V assembly. The commit history of this project is almost the same as the original project, only the codegen part has been ported to RISC-V.
